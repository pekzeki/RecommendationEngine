...
public class WordCountsInDocuments extends Configured implements Tool {
    ...
    private static final String OUTPUT_PATH = "/user/admin/project/tfidf/output/2-word-counts";
    private static final String INPUT_PATH = "/user/admin/project/tfidf/output/1-word-freq";
    ...
    public static class WordCountsForDocsMapper extends Mapper<LongWritable, Text, Text, Text> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String docName = wordAndDocCounter[0];
            this.docName.set(docName);
            this.wordAndCount.set(wordAndDocCounter[1] + "=" + wordAndDocCounter[2]);
